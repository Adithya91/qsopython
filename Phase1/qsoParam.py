...
#    plot(wavelengthsMatrix[0:sizes[q],q], spectrumsMatrix[0:sizes[q],q],'black','wavelength','flux','usual flux','file')
    ...
    #print(newSizes[q])
    #plot(wavelengthsMatrixFiltered[0:newSizes[q],q], continuumMatrixFiltered[0:newSizes[q],q],'black','wavelength','flux','filtered continuum of 12th qso','file')
    ...
    #plot(wavelengthsMatrix[0:newSizes[q],q], cfunDcfun['continuum'][0:newSizes[q],q],'black','wavelength','flux','filtered continuum of 12th qso','file')
...
def parameterization(QsoCL,qso,options):
    ...
    for i in range(max_iter):
     ...
     plt.show()
     plot(wavelengthsMatrix[0:sizes[q],q], spectrumsMatrix[0:sizes[q],q],'black','wavelength','flux','12th qso','file')
     plot(wavelengthsMatrix[0:sizes[q],q], continuumsMatrix[0:sizes[q],q],'black','wavelength','flux','final continuum of 12th qso','file')
     ...
     #drawChosenSpectrumWithPeaksRawData(q, spectrumsMatrixEmissionLines, wavelengthsMatrix, outputfit, getParams(qsos), sizesVector)

...
import os
from quasarParam import parameterization
...
def main():
 ...
 data directories
 '''
    feTempDir = '/home/adithya/Desktop/Phase2/data/Fe_templates/'
    sdssDir = '/home/adithya/Desktop/Phase2/data/fits/'
    dtpath = '/home/adithya/Desktop/Phase2/data/'
 ...
 '''
    ...
    QuasarCL = Quasarcl() #Initialize an object of type Quasarcl
    
    start = time.time()
    result = parameterization(QuasarCL,qso,options)#Run Parameterization
    end = time.time()
    t = end - start
